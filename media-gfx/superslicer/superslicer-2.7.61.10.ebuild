...
PATCHES=(
	"${FILESDIR}/${PN}-2.7.61.7-find-libexpat.patch"
	"${FILESDIR}/${PN}-2.7.61.7-fix-cutsurface.patch"
	"${FILESDIR}/${PN}-2.7.61.7-fix-boost-process.patch"
	"${FILESDIR}/${PN}-2.7.61.7-fix-seamplacer.patch"
	"${FILESDIR}/${PN}-${PV}-link-occtwrapper-statically.patch"
	"${FILESDIR}/${PN}-${PV}-fix-gcode-cpp.patch"
)
